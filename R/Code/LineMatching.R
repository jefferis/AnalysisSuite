...
LinesetEuclideanDistance<-function(l1, l2){
	...
	# For matching, there should be n equal length segments
	# Reference: An = (an,bhatn,Ln)
	# Sample:    Xn = (xn,yhatn,Ln)
	# point, unit direction vector, Length
	
	# distance = Sum for n=1 to N
	# [ln ||an-xn||^2 +ln^3(1-bhatn.yhatn)/6]
	...
	m1=l1.seglengths*normbyrow(pointDiffs)^2
