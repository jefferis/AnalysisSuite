...
test.ReadAM3D<-function(){
	...
	result=structure(list(NeuronName = "Neurites", NumPoints = 291L, StartPoint = 1L, 
	    ...
	    -291L)), OrientInfo = structure(list(AxonOriented = TRUE, 
	        AVMPoint = NA, AVLPoint = NA, Scl = c(1, 1, 1), NewAxes = c(1, 
	        2, 3)), .Names = c("AxonOriented", "AVMPoint", "AVLPoint", 
	    "Scl", "NewAxes"))), .Names = c("NeuronName", "NumPoints", 
